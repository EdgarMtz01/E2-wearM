 ...
 <!-- Inicia Seccion de ofertas-->
    ...
    <!-- Termina sección de ofertas -->
    <!--/ Inicio Actualidad-->
    <section>
        <div class="container-fluid text-center">
            <h2 class="text-primary">Actualidad</h2>
        </div>
        <div class="row justify-content-center">
            <div class="row justify-content-center">
                <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/otoño2.jpg" alt="Card image cap">
            </div>
            <div class="row justify-content-center">
                <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/otoño.jpg" alt="Card image cap">
            </div>
            <div class="container-fluid text-center">
